...
```@meta
EditURL = "https://github.com/EpiAware/EpiAwarePackageTools.jl/blob/main/NEWS.md"
```

# Release notes

EpiAwarePackageTools.jl follows a hybrid changelog approach:
...
See [GitHub Releases](https://github.com/EpiAware/EpiAwarePackageTools.jl/releases) for minor/patch
release information.
